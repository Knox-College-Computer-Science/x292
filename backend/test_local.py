...
db.add(profile)
db.commit()
print(f"✓ Profile created for user (ID: {profile.id})")
...
print("\n2️⃣  TEST: Update User Profile (Registration Steps)")
print("-" * 60)
...
print("✓ Step 1 - Basic Info updated")
...
print("✓ Step 2 - Health Info updated")
...
print("✓ Step 3 - Preferences updated")
...
if existing_clinic:
    ...
    db.commit()
    print("✓ Cleaned up existing test clinic")
...
db.add(clinic)
db.commit()
print(f"✓ Clinic created: {clinic.clinic_name} (ID: {clinic.id})")
...
print("\n4️⃣  TEST: Database Verification")
print("-" * 60)
...
print(f"✓ Total User Profiles: {profile_count}")
print(f"✓ Total Clinic Profiles: {clinic_count}")
...
print(f"\n✓ Password verification: {'✅ PASSED' if is_valid else '❌ FAILED'}")
